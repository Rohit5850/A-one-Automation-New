        ...
        <div className="grid gap-14 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-5 text-[16px] leading-8 text-gray-300">
              Expert Industrial Automation & Electrical Control Solutions.
            </p>
          ...
          <div>
            <h3 className="mb-8 text-[21px] font-bold">Quick Links</h3>
          ...
          <div>
            <h3 className="mb-8 text-[21px] font-bold">Our Services</h3>
          ...
          <div>
            <h3 className="mb-8 text-[21px] font-bold">Get In Touch</h3>
            ...
            <h4 className="mt-10 mb-6 text-[21px] font-bold">Find Us Online</h4>
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
            <p className="text-gray-400 text-[14px]">
              © 2026 A-one Automation Solutions. All Rights Reserved.
            </p>

            <p className="text-gray-400 text-[14px]">GST : 23ANCPY6310J1ZY</p>
          </div>
        </div>
      </div>
    </footer>
